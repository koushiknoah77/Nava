...
const AbstractReuse = () => (
  <div className="absolute inset-0 overflow-hidden bg-emerald-50/50">
    <svg className="absolute inset-0 w-full h-full opacity-20" viewBox="0 0 100 100" preserveAspectRatio="none">
      <defs>
        <pattern id="reuse-pattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
          <circle cx="10" cy="10" r="1" fill="#34A853" />
        </pattern>
      </defs>
      <rect width="100" height="100" fill="url(#reuse-pattern)" />
      <path d="M20,50 Q50,20 80,50 T20,50" fill="none" stroke="#34A853" strokeWidth="0.5" className="animate-pulse" />
      <path d="M10,40 Q50,70 90,40" fill="none" stroke="#34A853" strokeWidth="0.2" opacity="0.5" />
    </svg>
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-emerald-400/10 rounded-full blur-[80px]"></div>
    <div className="absolute bottom-10 right-10 opacity-10 text-emerald-600 rotate-12">
...
const AbstractUpgrade = () => (
  <div className="absolute inset-0 overflow-hidden bg-blue-50/50">
    <svg className="absolute inset-0 w-full h-full opacity-20" viewBox="0 0 100 100" preserveAspectRatio="none">
       <line x1="0" y1="100" x2="100" y2="0" stroke="#4285F4" strokeWidth="0.5" strokeDasharray="2 2" />
       <circle cx="70" cy="30" r="15" fill="none" stroke="#4285F4" strokeWidth="0.2" />
       <path d="M10,90 L30,70 L40,75 L70,45 L80,50 L100,20" fill="none" stroke="#4285F4" strokeWidth="1" strokeLinecap="round" />
    </svg>
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-blue-400/10 rounded-full blur-[80px]"></div>
    <div className="absolute bottom-10 right-10 opacity-10 text-blue-600 -rotate-12">
...
const AbstractIdeas = () => (
  <div className="absolute inset-0 overflow-hidden bg-amber-50/50">
    <div className="absolute inset-0 bg-[radial-gradient(#FBBC04_1px,transparent_1px)] bg-[size:30px_30px] opacity-10"></div>
    <svg className="absolute inset-0 w-full h-full opacity-20" viewBox="0 0 100 100">
       <circle cx="50" cy="50" r="20" fill="none" stroke="#FBBC04" strokeWidth="0.5" strokeDasharray="1 3" className="animate-[spin_20s_linear_infinite]" />
       <circle cx="50" cy="50" r="30" fill="none" stroke="#FBBC04" strokeWidth="0.3" strokeDasharray="4 4" className="animate-[spin_30s_linear_infinite_reverse]" />
    </svg>
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-amber-400/10 rounded-full blur-[80px]"></div>
    <div className="absolute bottom-10 right-10 opacity-10 text-amber-600 rotate-45">
...
const AbstractFixBuild = () => (
  <div className="absolute inset-0 overflow-hidden bg-slate-900">
    ...
    <div className="absolute -right-20 -bottom-20 opacity-20 text-white">
        <Wrench size={300} strokeWidth={0.5} />
    </div>
    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-slate-900 via-slate-900/80 to-transparent"></div>
  </div>
);
...
export const LandingPage: React.FC<LandingPageProps> = ({ onStart, onUpload }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#4285F4] selection:text-white overflow-x-hidden relative text-[#1F1F1F]">
      ...
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ease-[cubic-bezier(0.2,0,0,1)] pointer-events-none ${scrolled ? 'py-4' : 'py-8'}`}>
        <div className={`${containerClass} flex items-center justify-between pointer-events-auto`}>
            ...
            <div className={`flex items-center gap-3 transition-all duration-500 ${scrolled ? 'bg-white/80 backdrop-blur-xl shadow-sm pl-4 pr-6 py-3 rounded-full border border-white/20' : ''}`}>
               <div className="w-10 h-10 bg-[#1F1F1F] rounded-full flex items-center justify-center text-white shadow-md">
      ...
      <section className={`relative min-h-[95vh] flex flex-col justify-center pt-32 pb-24`}>
          <div className={`${containerClass} w-full relative z-10 flex flex-col items-center text-center`}>
              ...
              <h1 className="text-[13vw] lg:text-[160px] leading-[0.9] font-display font-medium text-[#1F1F1F] tracking-tighter mb-12 animate-fade-up opacity-0" style={{ animationDelay: '0.2s' }}>
                  Build things from<br />
                  <span className="gemini-gradient-text">the real world.</span>
              </h1>
              ...
              <div className="flex flex-col items-center gap-12 animate-fade-up opacity-0 max-w-3xl mx-auto" style={{ animationDelay: '0.4s' }}>
                  <p className="text-2xl md:text-3xl text-[#444746] font-normal leading-relaxed tracking-tight">
                      Turn your objects into finished projects with step-by-step AI help.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                     ...
                     >
                        <Upload size={22} className="text-[#5E5E5E]" /> 
                        Use a Photo
                     </button>
                  </div>
              </div>
          ...
          <div className={containerClass}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                  <div className="max-w-xl">
                      <h2 className="text-5xl md:text-7xl font-display font-medium text-[#1F1F1F] mb-10 leading-[1.05] tracking-tight">
                  ...
                  <div className="grid gap-6">
                      {[
                          ...
                          <div key={i} className={`group flex items-center gap-8 p-8 ${cardRadius} bg-white border border-[#E3E3E3] shadow-sm hover:shadow-lg hover:border-[#D3E3FD] transition-all duration-300 cursor-default`}>
                              <div className={`w-16 h-16 rounded-3xl ${item.bg} flex items-center justify-center ${item.color} group-hover:scale-110 transition-transform duration-500 shrink-0`}>
                                  {item.icon}
                              </div>
      ...
      <section className="px-4 md:px-6 py-12">
          <div className={`bg-[#F0F4F9] ${sectionRadius} py-24 md:py-32 overflow-hidden relative`}>
            ...
            <div className={containerClass + " relative z-10"}>
                <h2 className="text-5xl md:text-8xl font-display font-medium mb-20 text-center tracking-tighter text-[#1F1F1F]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div 
                        onClick={onStart}
                        className={`group relative h-[560px] ${cardRadius} bg-black overflow-hidden cursor-pointer hover:shadow-2xl transition-all duration-500 hover:-translate-y-2`}
                    >
                        <AbstractReuse />
                        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent"></div>
                        
                        <div className="absolute top-10 left-10 right-10">
                            <h3 className="text-4xl font-display font-medium text-white mb-3 leading-tight">Remake things</h3>
                            <p className="text-white/80 font-normal text-xl leading-snug">Turn old items into something new.</p>
                        </div>
                        
                        <div className="absolute bottom-10 left-10">
                           <div className="bg-white text-[#1F1F1F] px-8 py-4 rounded-full font-medium text-sm hover:bg-[#F8F9FA] transition-colors flex items-center gap-2">
                    ...
                    <div 
                        onClick={onStart}
                        className={`group relative h-[560px] ${cardRadius} bg-[#1F1F1F] overflow-hidden cursor-pointer hover:shadow-2xl transition-all duration-500 hover:-translate-y-2`}
                    >
                        <AbstractUpgrade />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent"></div>
                        
                        <div className="absolute top-10 left-10 right-10 z-10">
                            <h3 className="text-4xl font-display font-medium text-white mb-3 leading-tight">Better items</h3>
                            <p className="text-white/80 font-normal text-xl leading-snug">Upgrade what you own with AI tips.</p>
                        </div>

                        <div className="absolute bottom-10 left-10 z-10">
                           <div className="bg-white text-[#1F1F1F] px-8 py-4 rounded-full font-medium text-sm hover:bg-[#F8F9FA] transition-colors flex items-center gap-2">
                              Try Upgrade <ArrowRight size={16} />
                           </div>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="absolute top-10 left-10 right-10">
                            <h3 className="text-4xl font-display font-medium text-white mb-3 leading-tight">New ideas</h3>
                            <p className="text-white/80 font-normal text-xl leading-snug">Get matches for your materials.</p>
                        </div>
                        
                        <div className="absolute bottom-10 left-10">
                           <div className="bg-white text-[#1F1F1F] px-8 py-4 rounded-full font-medium text-sm hover:bg-[#F8F9FA] transition-colors flex items-center gap-2">
                              Get Inspired <ArrowRight size={16} />
                           </div>
                        </div>
                    </div>
                    ...
                    <div 
                        onClick={onStart}
                        className={`lg:col-span-3 group relative h-[420px] ${cardRadius} bg-[#1E1E1E] overflow-hidden cursor-pointer hover:shadow-2xl transition-all duration-500 flex flex-col md:flex-row hover:-translate-y-2`}
                    >
                          <AbstractFixBuild />
                          ...
                          <div className="relative z-10 p-12 md:p-16 flex flex-col justify-between h-full md:w-1/2">
                              ...
                              <div>
                                   <div className="bg-white text-[#1F1F1F] px-10 py-4 rounded-full font-medium text-sm hover:bg-[#F8F9FA] transition-colors flex items-center gap-2 w-fit">
      ...
      <footer className="py-16 bg-white border-t border-[#E3E3E3]">
          <div className={`${containerClass} flex flex-col md:flex-row justify-between items-center text-[#5E5E5E] text-sm font-medium`}>
              <div className="flex items-center gap-4 mb-8 md:mb-0">
                  <div className="relative flex h-2.5 w-2.5">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#34A853] opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#34A853]"></span>
                  </div>
                  <span className="tracking-wide font-mono text-xs uppercase text-[#1F1F1F]">Online</span>
              </div>
              <div className="flex flex-wrap justify-center gap-10 md:gap-16">
                  ...
                  <span className="opacity-50 font-mono text-xs">Powered by Gemini</span>
              </div>
          </div>
      </footer>
